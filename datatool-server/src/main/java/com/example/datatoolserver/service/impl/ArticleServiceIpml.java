...
import com.example.datatoolserver.common.Patterns;
...
import com.example.datatoolserver.util.CollectionUtil;
import com.example.datatoolserver.util.CrawlerUtil;
import com.example.datatoolserver.util.SpiderUtil;
...
//            }
    ...
    public String alterArticle(Map<String, Object> article) throws JOSEException {
        ...
        if (thumbMediaId == null){
            ...
            thumbMediaId = com.example.datatoolserver.util.token.creatToken(maps);
        }
...
//                articles = videoMapper.selectVideoTiele(pag);
            ...
            if (name.equals("热门")){
                //查询品牌课程
                brandCourses = brandCourseMapper.selectBrandName("社群营销",pag);
