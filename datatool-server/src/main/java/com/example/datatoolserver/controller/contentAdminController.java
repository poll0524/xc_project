...
//    }
     ...
     */
    @ResponseBody
    @PostMapping("/adminBrandData")
    public ReturnVO<Map<String,Object>> adminBrandData(@RequestBody Map<String,Object> data , @RequestHeader("userToken") String userToken){
        return new ReturnVO(contentAdminService.adminBrandData(data,userToken));
    }
     ...
     */
    @ResponseBody
    @PostMapping("/adminBrandNav")
    public ReturnVO<List<Map<String,Object>>> adminBrandNav(@RequestBody Map<String,Object> data , @RequestHeader("userToken") String userToken){
        return new ReturnVO(contentAdminService.adminBrandNav(data,userToken));
    }
     ...
     */
    @ResponseBody
    @PostMapping("/adminBrandArticle")
    public ReturnVO<Map<String,Object>> adminBrandArticle(@RequestBody Map<String,Object> data , @RequestHeader("userToken") String userToken){
        return new ReturnVO(contentAdminService.adminBrandArticle(data,userToken));
    }
     ...
     */
    @ResponseBody
    @PostMapping("/adminBrandVideo")
    public ReturnVO<Map<String,Object>> adminBrandVideo(@RequestBody Map<String,Object> data , @RequestHeader("userToken") String userToken){
        return new ReturnVO(contentAdminService.adminBrandVideo(data,userToken));
    }
     ...
     */
    @ResponseBody
    @PostMapping("/adminBrandClassify")
    public ReturnVO<Map<String,Object>> adminBrandClassify(@RequestBody Map<String,Object> data , @RequestHeader("userToken") String userToken){
        return new ReturnVO(contentAdminService.adminBrandClassify(data,userToken));
    }
