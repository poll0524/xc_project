...
import com.example.datatoolserver.pojo.BrandVideo;
...
public interface brandVideoMapper {
    ...
    List<BrandVideo> selectBrandVideoAdminSum(String openId);
    List<BrandVideo> selectBrandVideo(String openId, Integer pag);
