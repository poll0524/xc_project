...
public class WeChatUtil {
    ...
    public static final String AUTHOR = "孝粉云学堂";
    ...
    //测试号
    public static final String APPID = "wx4cb0f21739ce9406";
    public static final String APPSECRET = "8c19ef4a0f13b6e57ea34fb1add2c962";

    //正式号
//    public static final String APPID = "wx6a0dcf623263d8c0";
//    public static final String APPSECRET = "85b40c1e4c90e73aa72ac6e8db84ce78";
...
//    public static final String CERT_PATH = ClassUtils.getDefaultClassLoader().getResource("").getPath()+"weixin/apiclient_cert.p12";
    ...
    //沐子新openid
    public static final String MUZIXIN = "o_1iov6V_1gg_A6S4B8f0sBT7K6k";
}
