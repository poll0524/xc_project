...
import com.example.xcschoolserver.common.WX_Util;
import com.example.xcschoolserver.common.WeChatUtil;
import com.example.xcschoolserver.mapper.groupTopMapper;
import com.example.xcschoolserver.mapper.pushMapper;
...
import com.example.xcschoolserver.service.IWeixinInertfaceService;
...
//                + "#wechat_redirect";
            ...
            //线下
        String url ="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx4cb0f21739ce9406"
                //这个backUrl的域名必须要进行再公众号中进行注册验证，这个地址是成功后的回调地址,在配置文件配置
                + "&redirect_uri="+urlstr
                + "&response_type=code"
                + "&scope=snsapi_userinfo"
