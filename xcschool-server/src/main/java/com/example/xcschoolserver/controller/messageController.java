...
import com.example.xcschoolserver.service.IMessageService;
    ...
    public ReturnVO<Map<String,Object>>  shineUpon(@RequestBody Map<String,Object> data){
        ...
        if (readOpenId.equals(openId)){
            ...
            if (shineUpon == null){
                ...
                //如果存在其他关系
                if (shineUpon1 != null && !shineUpon1.getRead_open_id().equals(WeChatUtil.AUTHOR)){
                    Xcuser xcuser = xcuserMapper.selectOpenId(readOpenId);
                    return new ReturnVO(xcuser).error(40001,"与其他人,邀请关系已经存在");
                }else if (shineUpon1 != null && shineUpon1.getRead_open_id().equals(WeChatUtil.AUTHOR)){
                    //判断是否交换邀请
