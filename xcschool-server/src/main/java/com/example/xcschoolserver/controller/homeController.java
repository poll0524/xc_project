...
import com.example.xcschoolserver.mapper.productMapper;
...
public class homeController {
    ...
    public ReturnVO<List> topTeacher(){
        return new ReturnVO(homeService.topTeacher());
    }
    ...
    public ReturnVO<List> topCourse(){
        return new ReturnVO(homeService.topCourse());
    }
    ...
    public ReturnVO<List> topArticle(){
        return new ReturnVO(homeService.topArticle());
    }
}
